//! Images
import w11BgDark from "../assets/win11-bg-dark.jpg";
import babyYoda from "../assets/baby.jpg";

export { w11BgDark, babyYoda };
...
export const notepadIcon = (
  <img src="https://img.icons8.com/fluency/40/notepad.png" alt="notepad" />
);
export const vs2022Icon = (
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
    <linearGradient
...
export const imgFileIcon = (
  <img src="https://img.icons8.com/office/40/image-file.png" alt="image-file" />
);
...
export const leftShortArrowIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    viewBox="0 0 16 16"
...
export const extensionIcon = (
  <svg
    ...
    viewBox="0 0 26 26"
  >
    <path d="M 23 14 C 22.199219 14 21.800781 14.199219 21 14.800781 C 19.898438 15.601563 19.300781 16.101563 19 15 C 18.699219 14 18.101563 10 18 9.199219 C 17.898438 8.5 17.5 8.101563 17 8 C 17 8 13.101563 7.199219 12 7 C 11 6.800781 10.398438 6.300781 11.199219 5 C 11.800781 4.101563 12 3.800781 12 3 C 12 1.300781 10.699219 0 9 0 C 7.300781 0 6 1.300781 6 3 C 6 3.800781 6.300781 4.300781 6.800781 5 C 7.699219 6.300781 7.101563 6.800781 6 7 C 4.800781 7.300781 1 8 1 8 C 0.398438 8.101563 0 8.601563 0 9.199219 C 0 9.199219 0 10.800781 0 14.898438 C 0 14.898438 0 15 0 15 C 0.300781 16 1.101563 15.5 2 14.800781 C 2.601563 14.300781 3.300781 14 4 14 C 5.699219 14 7 15.300781 7 17 C 7 18.699219 5.699219 20 4 20 C 3.199219 20 2.699219 19.699219 1.898438 19.199219 C 1.300781 18.601563 0.199219 17.898438 0 19 C 0 19.101563 0 19.101563 0 19.199219 C 0 23.5 0 25 0 25 C 0 25.601563 0.398438 26 1 26 L 17 26 C 17.601563 26 17.898438 25.601563 18 25 C 18 25 18.800781 20.101563 19 19 C 19.199219 17.898438 19.800781 18.300781 20.898438 19.199219 C 21.5 19.601563 22.199219 20 23 20 C 24.699219 20 26 18.699219 26 17 C 26 15.300781 24.699219 14 23 14 Z"></path>
  </svg>
);
...
export const micColoredIcon = (
  <img src="https://img.icons8.com/color/48/microphone.png" alt="microphone" />
);
export const cameraIcon = (
  <img src="https://img.icons8.com/color/48/camera.png" alt="camera" />
);
